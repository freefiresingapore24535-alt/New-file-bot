...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8514251249:AAHsmNpGX41EIAKP-T1y66Tgv6nbBQDPgbA")
...
DB_NAME = os.environ.get("DATABASE_NAME", "Remo")
#--------------------------------------------
FSUB_LINK_EXPIRY = int(os.getenv("FSUB_LINK_EXPIRY", "20"))  # 0 means no expiry
BAN_SUPPORT = os.environ.get("BAN_SUPPORT", "https://t.me/SkSupportGroup")
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ <a href='https://t.me/+AdcXPREPNEpkZmNl'>Cʟɪᴄᴋ ʜᴇʀᴇ</a>•</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
...
SCREENSHOT_URL = os.environ.get("SCREENSHOT_URL", "https://t.me/Minato_Sencie")
#--------------------------------------------
#Time and its price
#7 Days
